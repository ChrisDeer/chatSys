      ...
      <div class="theme-list">
        ...
        <div class="theme-item">
          ...
          <el-radio-group v-model="bgImg" size="small" @change="bgImgChange">
            ...
            <el-radio label="wood" border>木纹</el-radio>
            <el-radio label="photoWall" border>照片墙</el-radio>
            <el-radio label="draw" border>涂鸦</el-radio>
...
const systemPictureMap = {
  ...
  wood: require('./../../../static/image/theme/wood.jpg'),
  photoWall: require('./../../../static/image/theme/photoWall.jpg'),
  draw: require('./../../../static/image/theme/draw.jpg')
}
